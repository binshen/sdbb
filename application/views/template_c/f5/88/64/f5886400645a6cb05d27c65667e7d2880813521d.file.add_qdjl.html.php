<?php /* Smarty version Smarty-3.1.16, created on 2015-07-03 10:28:03
         compiled from "application/views/pc/add_qdjl.html" */ ?>
<?php /*%%SmartyHeaderCode:9935074965595f333e61291-65539486%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5886400645a6cb05d27c65667e7d2880813521d' => 
    array (
      0 => 'application/views/pc/add_qdjl.html',
      1 => 1433315275,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9935074965595f333e61291-65539486',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5595f333f03ec6_69739432',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5595f333f03ec6_69739432')) {function content_5595f333f03ec6_69739432($_smarty_tpl) {?><?php if (!is_callable('smarty_function_site_url')) include '/var/www/html/sdbb/application/libraries/smarty/plugins/function.site_url.php';
?><!DOCTYPE html>
...
<span>(<?php if ($_smarty_tpl->tpl_vars['admin_group']->value=='1') {?>管理员<?php }?><?php if ($_smarty_tpl->tpl_vars['admin_group']->value=='2') {?>客服经理<?php }?><?php if ($_smarty_tpl->tpl_vars['admin_group']->value=='3') {?>业务员<?php }?><?php if ($_smarty_tpl->tpl_vars['admin_group']->value=='4') {?>外联经理<?php }?><?php if ($_smarty_tpl->tpl_vars['admin_group']->value=='5') {?>门店经理<?php }?>)</span></p>
    <p class="zbb"><a href="<?php echo smarty_function_site_url(array('url'=>'admin_pc/qdjlgl'),$_smarty_tpl);?>
">渠道经理列表</a>总报备： <span><?php echo $_smarty_tpl->tpl_vars['all_count']->value['bb_count'];?>
